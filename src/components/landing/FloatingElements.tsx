...
export default function FloatingElements() {
  ...
  return (
    <>
      ...
      {/* WhatsApp FAB */}
      <a
        href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent("Hi Mix Media! I'd like to know more about your services.")}`}
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-20 lg:bottom-6 right-6 z-[999] w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center animate-pulse-ring hover:scale-110 transition-transform"
